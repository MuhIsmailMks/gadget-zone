...
// hero products
export const heroProductStyling = {
    heroSize:' w-full h-[603px] xl-desktop:h-[900px]  max-s-desktop:h-[40vw] s_desktop-xl_tablet:h-[40vw] mobile:mt-[3rem] mobile:h-[40vw] phone:mt-0 phone:h-[75vw]',
    property:'relative'
}

// benefits section styling 
export const benefitStylingContainer = {
    property:' flex-wrap my-[3rem] gap-[1.25rem] px-[4rem] phone:px-[2rem] phone:my-[2rem] x-phone:my-[2rem]'
}

export const benefitStyling = {
    text:'text-primary-color font-Lato text-[1rem] font-[500] tablet:text-[.9rem] phone:text-[.7rem]   x-phone:text-[.55rem]',
...
export const specialProductStyling = { 
...
export const popularProductContainerStyling = { 
    property:"gap-[2rem] mobile:gap-[1rem] px-[2rem] phone:gap-[2.5rem] phone:px-[1rem]", 
}

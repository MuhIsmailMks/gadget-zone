...
export const shoppingBagContainer = {
    ...
    productList:{
        ...
        aboutProductContainer:'w-[100%] h-[50px] phone-mtablet:h-[40px] bg-white flex justify-end text-black items-center px-[.5rem] gap-[.3rem]  shadow-shopBagComponentsShadow',
        description_size:'text-center relative h-full w-[100px] '
    },
    ...
    priceContainer:{ 
        ...
        property:" z-[999] shadow-shopBagComponentsShadow rounded-[15px] text-[#eee] gap-[0.938rem] phone-mtablet:justify-start xl-tablet:gap-[.5rem] phone-mtablet:gap-[.4rem] mobile:pt-[1.25rem] mobile:pb-[4rem] mobile:rounded-[0px] ",
        checkButton:'bg-[#439CEF] text-[white] pt-[.35rem] rounded-[25px]  ', 
        itemProperty:'max-w-[90%] w-[366px] h-[30px] flex justify-between mobile:w-[70%] phone-mtablet:w-[90%]',
        line:" w-[366px] line my-[.3rem]  h-[1px]  mobile:w-[70%] phone-mtablet:w-[90%] bg-[#D7D7D7]"
    }
...
export const bagItem = {
    ...
    component:{
        image_name_product:'h-[100%] w-[auto] min-w-[250px] phone-mtablet:min-w-[150px] relative flex phone-mtablet:flex-col mobile:h-[auto] mobile:text-center',
        imageSize:'h-[90px] w-[90px] mobile:h-[80px] mobile:w-[auto] phone-mtablet:h-[50px]',
    }
}